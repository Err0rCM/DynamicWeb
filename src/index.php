    ...
    <form class="form-getflag" method="post">
        <div id="app">
            ...
            if ($result = $mysqli->query("SELECT
                ...
                WHERE
                    randChallenges.studentid = '".$_SESSION['studentid']."'
...
//    echo $getscroe;
    if($result = $mysqli->query("select * from score where username='".addslashes_deep($_SESSION['username'])."'")) {
        if ($result->num_rows) {
            ...
            insert into userAnswer values (NULL, '".$_SESSION['studentid']."', '".$_POST['q1']."', '".$_POST['q2']."', '".$_POST['q3']."', '".$_POST['q4']."', '".$_POST['q5']."')";
